...
<div id="sort-buttons">
  <div class="dropdown">
    ...
    <div class="dropdown-content" id="dropdownContent">
      ...
      -->
      <a href="#" onclick="sortAch('date', 'desc')">Date</a>
      <a href="#" onclick="sortAch('placement', 'desc')">Placement</a>
    </div>
  </div>
</div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // BUGGED: Set all links to open in new tab
  ...
  function sortAch(criteria, order) {
