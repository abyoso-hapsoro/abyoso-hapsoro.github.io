  ...
  <div class="education-card" onclick="toggleDropdown(this, 'bachelor-semester-7')" id="bachelor" featured="true" feature-order="2">
    ...
    <div class="education-dropdown">
      <div class="education-journey">
        ...
        <div id="education-report">
          <div class="education-semester" id="bachelor-semester-1">
          ...
          <div class="education-semester" id="bachelor-semester-2">
          ...
          <div class="education-semester" id="bachelor-semester-3">
          ...
          <div class="education-semester" id="bachelor-semester-4">
          ...
          <div class="education-semester" id="bachelor-semester-4.5">
          ...
          <div class="education-semester" id="bachelor-semester-5">
          ...
          <div class="education-semester" id="bachelor-semester-6">
          ...
          <div class="education-semester" id="bachelor-semester-7">
          ...
          <div class="education-semester" id="bachelor-semester-8">
      ...
      <img class="education-grading" src="../images/Grading_System-Bachelor.png">
    </div>
  </div>
...
<div id="smifrm" class="tabcontent" type="Semi-Formal">
  <div class="education-card no-dropdown" featured="true" feature-order="3">
    <div class="education-header">
...
<script>
  ...
  function toggleSemester(event, eduCard, semester) {
    ...
    const allDetails = document.querySelectorAll(".education-semester");
    allDetails.forEach((detail) => (detail.style.display = "none"));

    // Show the selected semester's details
    const selectedDetail = document.getElementById(`${eduCard}-semester-${semester}`);
    if (selectedDetail) {
      selectedDetail.style.display = "block";
    }

    // Highlight the active semester node
    const allNodes = document.querySelectorAll(".education-node-point");
