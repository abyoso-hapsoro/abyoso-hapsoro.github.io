...
<div id="formal" class="tabcontent" type="Formal">
  <div class="education-card" featured="true" feature-order="1">
  ...
  <div class="education-card" id="bachelor" featured="true" feature-order="2">
    <div class="education-header">
...
<div id="smifrm" class="tabcontent" type="Semi-Formal">
  ...
  <div class="education-card" featured="true" feature-order="6">
    <div class="education-header">
